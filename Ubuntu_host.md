...
<p align="center">
  <img src="./docs/Images/ubuntu_logo.png" alt="Ubuntu logo" width="96">
</p>

> [!IMPORTANT]
> This is the canonical setup guide for a native Ubuntu 22.04 host.

## Prerequisites

| Category | Requirement |
| --- | --- |
| Host platform | x86 Ubuntu 22.04 |
...
This installs Docker Engine on the Ubuntu host and prepares the `docker` group workflow used by
`./docker/iqf`.

### STEP 4: Pull the Tested Image from Docker Hub
...
### STEP 5: Authenticate with Qualcomm AI Hub
...
This stores the host-side QAI Hub configuration in `~/.qai_hub/client.ini`.

After these steps, the Ubuntu host is ready for `qc`, `mAP`, and host-side `test`.
